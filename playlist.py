...
'''
Zion = {'artist': 'Lauryn Hill', 'title': 'Zion'}

add_song(my_playlist, Zion)
...
Love_Yours = {'artist' : 'J. Cole', 'title': 'Love Yours'}
Clean_Heart = {'artist': 'Lorvins', 'title': 'Clean Heart'}
add_song(my_playlist, Love_Yours)
add_song(my_playlist, Clean_Heart)
